...
Fixing solution : [Ridge regression]([Multicollinearity-part1.md](https://github.com/ramandrosoa/Linear-Regression/blob/main/R%20file/Multicollinearity-part1.md)) , variables selection
